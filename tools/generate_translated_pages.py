...
UI_STRINGS = {
    ...
    "th": {
        ...
        "faq": "คำถามที่พบบ่อย",
        "try_etoro": "ลอง eToro",
        "in_this_article": "ในบทความนี้",
        "prefer_reading": "อยากอ่านมากกว่า? บทถอดเสียงฉบับเต็มอยู่ด้านล่าง",
        "watch_on_youtube": "ดูบน YouTube พร้อมซับไตเติ้ล",
        "risk_warning_label": "คำเตือนความเสี่ยง",
        "risk_warning_banner": "คำเตือนความเสี่ยง: 51% ของบัญชีนักลงทุนรายย่อยขาดทุนเมื่อเทรด CFD กับ eToro เงินทุนของคุณมีความเสี่ยง",
        "risk_warning_full": "eToro เป็นแพลตฟอร์มการลงทุนหลายสินทรัพย์ มูลค่าการลงทุนของคุณอาจเพิ่มขึ้นหรือลดลงได้ 51% ของบัญชีนักลงทุนรายย่อยขาดทุนเมื่อเทรด CFD กับ eToro คุณควรพิจารณาว่าคุณสามารถรับความเสี่ยงสูงในการสูญเสียเงินได้หรือไม่",
        "risk_warning_footer": "เงินทุนของคุณมีความเสี่ยง 51% ของบัญชีนักลงทุนรายย่อยขาดทุนเมื่อเทรด CFD กับ eToro เว็บไซต์นี้มีไว้เพื่อการศึกษาและข้อมูลเท่านั้น ไม่ถือเป็นคำแนะนำการลงทุน Copy Trading ไม่ถือเป็นคำแนะนำการลงทุน",
        "risk_warning_sidebar": "51% ของบัญชีนักลงทุนรายย่อยขาดทุนเมื่อเทรด CFD กับ eToro คุณควรพิจารณาว่าคุณสามารถรับความเสี่ยงสูงในการสูญเสียเงินได้หรือไม่ นี่คือลิงก์พันธมิตร — Tom อาจได้รับค่าคอมมิชชั่นโดยไม่มีค่าใช้จ่ายกับคุณ",
        "important_reminder": "ข้อเตือนสำคัญ",
        "important_reminder_text": "51% ของบัญชีนักลงทุนรายย่อยขาดทุนเมื่อเทรด CFD กับ eToro คุณควรพิจารณาว่าคุณสามารถรับความเสี่ยงสูงในการสูญเสียเงินได้หรือไม่ ผลการดำเนินงานในอดีตไม่ได้บ่งชี้ถึงผลลัพธ์ในอนาคต เนื้อหานี้มีไว้เพื่อการศึกษาเท่านั้น ไม่ใช่คำแนะนำการลงทุน",
        "ready_to_try": "พร้อมลอง eToro แล้วหรือยัง?",
        "toms_affiliate": "Tom ใช้ eToro ตั้งแต่ปี 2017 นี่คือลิงก์พันธมิตรของเขา",
        "explore_etoro": "สำรวจ eToro →",
        "ready_cta_inline": "พร้อมลอง eToro? — ลิงก์พันธมิตรของ Tom",
        "more_guides": "คู่มือเพิ่มเติม",
        "guide_social": "Social Trading คืออะไร?",
        "guide_copy": "Copy Trading คืออะไร?",
        "guide_returns": "คุณจะได้กำไรเท่าไหร่?",
        "guide_scam": "eToro หลอกลวงหรือไม่?",
        "guide_profits": "การถอนกำไร",
        "guide_pi": "โปรแกรม Popular Investor",
        "guide_all_videos": "วิดีโอทั้งหมด",
        "footer_brand": "บันทึกเส้นทาง Copy Trading ตั้งแต่ปี 2017 อิสระ ซื่อสัตย์ และเรียนรู้อยู่เสมอ",
        "footer_guides": "คู่มือ",
        "footer_site": "เว็บไซต์",
        "footer_updates": "อัปเดตการเทรด",
    ...
    "id": {
        ...
        "about": "Tentang",
        "faq": "FAQ",
        "try_etoro": "Coba eToro",
        "in_this_article": "Dalam artikel ini",
        "prefer_reading": "Lebih suka membaca? Transkrip lengkapnya ada di bawah.",
        "watch_on_youtube": "Tonton di YouTube dengan subtitle",
        "risk_warning_label": "Peringatan risiko",
        "risk_warning_banner": "Peringatan risiko: 51% akun investor ritel kehilangan uang saat trading CFD dengan eToro. Modal Anda berisiko.",
        "risk_warning_full": "eToro adalah platform investasi multi-aset. Nilai investasi Anda bisa naik atau turun. 51% akun investor ritel kehilangan uang saat trading CFD dengan eToro. Anda harus mempertimbangkan apakah Anda mampu menanggung risiko tinggi kehilangan uang.",
        "risk_warning_footer": "Modal Anda berisiko. 51% akun investor ritel kehilangan uang saat trading CFD dengan eToro. Situs ini hanya untuk tujuan edukasi dan informasi, bukan nasihat investasi. Copy Trading bukan nasihat investasi.",
        "risk_warning_sidebar": "51% akun investor ritel kehilangan uang saat trading CFD dengan eToro. Anda harus mempertimbangkan apakah Anda mampu menanggung risiko tinggi kehilangan uang. Ini adalah tautan afiliasi — Tom mungkin menerima komisi tanpa biaya tambahan untuk Anda.",
        "important_reminder": "Pengingat penting",
        "important_reminder_text": "51% akun investor ritel kehilangan uang saat trading CFD dengan eToro. Anda harus mempertimbangkan apakah Anda mampu menanggung risiko tinggi kehilangan uang. Kinerja masa lalu bukan indikasi hasil di masa depan. Konten ini hanya untuk tujuan edukasi, bukan nasihat investasi.",
        "ready_to_try": "Siap mencoba eToro?",
        "toms_affiliate": "Tom telah menggunakan eToro sejak 2017. Ini tautan afiliasinya.",
        "explore_etoro": "Jelajahi eToro →",
        "ready_cta_inline": "Siap mencoba eToro? — Tautan afiliasi Tom.",
        "more_guides": "Panduan lainnya",
        "guide_social": "Apa itu Social Trading?",
        "guide_copy": "Apa itu Copy Trading?",
        "guide_returns": "Berapa yang bisa Anda hasilkan?",
        "guide_scam": "Apakah eToro penipuan?",
        "guide_profits": "Mengambil keuntungan",
        "guide_pi": "Program Popular Investor",
        "guide_all_videos": "Semua video",
        "footer_brand": "Mendokumentasikan perjalanan copy trading sejak 2017. Independen, jujur, dan selalu belajar.",
        "footer_guides": "Panduan",
        "footer_site": "Situs",
        "footer_updates": "Pembaruan trading",
    ...
    "ms": {
        ...
        "about": "Tentang",
        "faq": "Soalan Lazim",
        "try_etoro": "Cuba eToro",
        "in_this_article": "Dalam artikel ini",
        "prefer_reading": "Lebih suka membaca? Transkrip penuh ada di bawah.",
        "watch_on_youtube": "Tonton di YouTube dengan sarikata",
        "risk_warning_label": "Amaran risiko",
        "risk_warning_banner": "Amaran risiko: 51% akaun pelabur runcit kehilangan wang semasa berdagang CFD dengan eToro. Modal anda berisiko.",
        "risk_warning_full": "eToro ialah platform pelaburan pelbagai aset. Nilai pelaburan anda boleh naik atau turun. 51% akaun pelabur runcit kehilangan wang semasa berdagang CFD dengan eToro. Anda perlu mempertimbangkan sama ada anda mampu menanggung risiko tinggi kehilangan wang.",
        "risk_warning_footer": "Modal anda berisiko. 51% akaun pelabur runcit kehilangan wang semasa berdagang CFD dengan eToro. Laman web ini hanya untuk tujuan pendidikan dan maklumat, bukan nasihat pelaburan. Copy Trading bukan nasihat pelaburan.",
        "risk_warning_sidebar": "51% akaun pelabur runcit kehilangan wang semasa berdagang CFD dengan eToro. Anda perlu mempertimbangkan sama ada anda mampu menanggung risiko tinggi kehilangan wang. Ini adalah pautan ahli gabungan — Tom mungkin menerima komisen tanpa kos tambahan kepada anda.",
        "important_reminder": "Peringatan penting",
        "important_reminder_text": "51% akaun pelabur runcit kehilangan wang semasa berdagang CFD dengan eToro. Anda perlu mempertimbangkan sama ada anda mampu menanggung risiko tinggi kehilangan wang. Prestasi masa lalu bukan petunjuk keputusan masa depan. Kandungan ini hanya untuk tujuan pendidikan, bukan nasihat pelaburan.",
        "ready_to_try": "Bersedia mencuba eToro?",
        "toms_affiliate": "Tom telah menggunakan eToro sejak 2017. Ini pautan ahli gabungannya.",
        "explore_etoro": "Terokai eToro →",
        "ready_cta_inline": "Bersedia mencuba eToro? — Pautan ahli gabungan Tom.",
        "more_guides": "Panduan lanjut",
        "guide_social": "Apa itu Social Trading?",
        "guide_copy": "Apa itu Copy Trading?",
        "guide_returns": "Berapa yang boleh anda peroleh?",
        "guide_scam": "Adakah eToro penipuan?",
        "guide_profits": "Mengambil keuntungan",
        "guide_pi": "Program Popular Investor",
        "guide_all_videos": "Semua video",
        "footer_brand": "Mendokumentasikan perjalanan copy trading sejak 2017. Bebas, jujur, dan sentiasa belajar.",
        "footer_guides": "Panduan",
        "footer_site": "Laman",
        "footer_updates": "Kemaskini dagangan",
        "footer_about": "Tentang",
    ...
    "vi": {
        "social_trading": "Giao Dịch Xã Hội",
        "copy_trading": "Copy Trading",
        "updates": "Cập nhật",
        "videos": "Video",
        "about": "Giới thiệu",
        ...
        "try_etoro": "Thử eToro",
        "in_this_article": "Trong bài viết này",
        "prefer_reading": "Thích đọc hơn? Bản ghi đầy đủ ở bên dưới.",
        "watch_on_youtube": "Xem trên YouTube có phụ đề",
        "risk_warning_label": "Cảnh báo rủi ro",
        "risk_warning_banner": "Cảnh báo rủi ro: 51% tài khoản nhà đầu tư cá nhân thua lỗ khi giao dịch CFD với eToro. Vốn của bạn đang gặp rủi ro.",
        "risk_warning_full": "eToro là nền tảng đầu tư đa tài sản. Giá trị khoản đầu tư của bạn có thể tăng hoặc giảm. 51% tài khoản nhà đầu tư cá nhân thua lỗ khi giao dịch CFD với eToro. Bạn nên cân nhắc xem bạn có khả năng chịu rủi ro cao mất tiền hay không.",
        "risk_warning_footer": "Vốn của bạn đang gặp rủi ro. 51% tài khoản nhà đầu tư cá nhân thua lỗ khi giao dịch CFD với eToro. Trang web này chỉ dành cho mục đích giáo dục và thông tin, không phải lời khuyên đầu tư. Copy Trading không phải là lời khuyên đầu tư.",
        "risk_warning_sidebar": "51% tài khoản nhà đầu tư cá nhân thua lỗ khi giao dịch CFD với eToro. Bạn nên cân nhắc xem bạn có khả năng chịu rủi ro cao mất tiền hay không. Đây là liên kết liên kết — Tom có thể nhận hoa hồng mà không tốn thêm chi phí cho bạn.",
        "important_reminder": "Lưu ý quan trọng",
        "important_reminder_text": "51% tài khoản nhà đầu tư cá nhân thua lỗ khi giao dịch CFD với eToro. Bạn nên cân nhắc xem bạn có khả năng chịu rủi ro cao mất tiền hay không. Hiệu suất trong quá khứ không phải là chỉ báo cho kết quả tương lai. Nội dung này chỉ dành cho mục đích giáo dục, không phải lời khuyên đầu tư.",
        "ready_to_try": "Sẵn sàng thử eToro?",
        "toms_affiliate": "Tom đã dùng eToro từ năm 2017. Đây là liên kết liên kết của anh ấy.",
        "explore_etoro": "Khám phá eToro →",
        "ready_cta_inline": "Sẵn sàng thử eToro? — Liên kết liên kết của Tom.",
        "more_guides": "Thêm hướng dẫn",
        "guide_social": "Giao dịch xã hội là gì?",
        "guide_copy": "Copy Trading là gì?",
        "guide_returns": "Bạn có thể kiếm được bao nhiêu?",
        "guide_scam": "eToro có lừa đảo không?",
        "guide_profits": "Rút lợi nhuận",
        "guide_pi": "Chương trình Popular Investor",
        "guide_all_videos": "Tất cả video",
        "footer_brand": "Ghi lại hành trình copy trading từ năm 2017. Độc lập, trung thực và luôn học hỏi.",
        "footer_guides": "Hướng dẫn",
        "footer_site": "Trang web",
        "footer_updates": "Cập nhật giao dịch",
    ...
    "sv": {
        ...
        "about": "Om oss",
        "faq": "Vanliga frågor",
        "try_etoro": "Prova eToro",
        "in_this_article": "I den här artikeln",
        "prefer_reading": "Föredrar du att läsa? Den fullständiga transkriptionen finns nedan.",
        "watch_on_youtube": "Titta på YouTube med undertexter",
        "risk_warning_label": "Riskvarning",
        "risk_warning_banner": "Riskvarning: 51% av privata investerarkonton förlorar pengar vid CFD-handel med eToro. Ditt kapital är i fara.",
        "risk_warning_full": "eToro är en investeringsplattform för flera tillgångsslag. Värdet på dina investeringar kan stiga eller sjunka. 51% av privata investerarkonton förlorar pengar vid CFD-handel med eToro. Du bör överväga om du har råd med den höga risken att förlora dina pengar.",
        "risk_warning_footer": "Ditt kapital är i fara. 51% av privata investerarkonton förlorar pengar vid CFD-handel med eToro. Denna webbplats är enbart för utbildnings- och informationssyfte och utgör inte investeringsrådgivning. Copy Trading utgör inte investeringsrådgivning.",
        "risk_warning_sidebar": "51% av privata investerarkonton förlorar pengar vid CFD-handel med eToro. Du bör överväga om du har råd med den höga risken att förlora dina pengar. Detta är en affiliate-länk — Tom kan få en provision utan kostnad för dig.",
        "important_reminder": "Viktig påminnelse",
        "important_reminder_text": "51% av privata investerarkonton förlorar pengar vid CFD-handel med eToro. Du bör överväga om du har råd med den höga risken att förlora dina pengar. Tidigare resultat är ingen indikation på framtida resultat. Detta innehåll är enbart för utbildningssyfte och utgör inte investeringsrådgivning.",
        "ready_to_try": "Redo att prova eToro?",
        "toms_affiliate": "Tom har varit på eToro sedan 2017. Här är hans affiliate-länk.",
        "explore_etoro": "Utforska eToro →",
        "ready_cta_inline": "Redo att prova eToro? — Toms affiliate-länk.",
        "more_guides": "Fler guider",
        "guide_social": "Vad är Social Trading?",
        "guide_copy": "Vad är Copy Trading?",
        "guide_returns": "Hur mycket kan du tjäna?",
        "guide_scam": "Är eToro en bluff?",
        "guide_profits": "Ta ut vinster",
        "guide_pi": "Popular Investor-programmet",
        "guide_all_videos": "Alla videor",
        "footer_brand": "Dokumenterar copy trading-resan sedan 2017. Oberoende, ärlig och ständigt lärande.",
        "footer_guides": "Guider",
        "footer_site": "Webbplats",
        "footer_updates": "Handelsuppdateringar",
        "footer_about": "Om oss",
    ...
    "da": {
        ...
        "try_etoro": "Prøv eToro",
        "in_this_article": "I denne artikel",
        "prefer_reading": "Foretrækker du at læse? Den fulde transskription er nedenfor.",
        "watch_on_youtube": "Se på YouTube med undertekster",
        "risk_warning_label": "Risikoadvarsel",
        "risk_warning_banner": "Risikoadvarsel: 51% af private investorkonti taber penge ved CFD-handel med eToro. Din kapital er i fare.",
        "risk_warning_full": "eToro er en multi-aktiv investeringsplatform. Værdien af dine investeringer kan stige eller falde. 51% af private investorkonti taber penge ved CFD-handel med eToro. Du bør overveje, om du har råd til den høje risiko for at tabe dine penge.",
        "risk_warning_footer": "Din kapital er i fare. 51% af private investorkonti taber penge ved CFD-handel med eToro. Denne hjemmeside er udelukkende til uddannelses- og informationsformål og udgør ikke investeringsrådgivning. Copy Trading udgør ikke investeringsrådgivning.",
        "risk_warning_sidebar": "51% af private investorkonti taber penge ved CFD-handel med eToro. Du bør overveje, om du har råd til den høje risiko for at tabe dine penge. Dette er et affiliate-link — Tom kan modtage en provision uden omkostninger for dig.",
        "important_reminder": "Vigtig påmindelse",
        "important_reminder_text": "51% af private investorkonti taber penge ved CFD-handel med eToro. Du bør overveje, om du har råd til den høje risiko for at tabe dine penge. Tidligere resultater er ingen indikation for fremtidige resultater. Dette indhold er udelukkende til uddannelsesformål og udgør ikke investeringsrådgivning.",
        "ready_to_try": "Klar til at prøve eToro?",
        "toms_affiliate": "Tom har været på eToro siden 2017. Her er hans affiliate-link.",
        "explore_etoro": "Udforsk eToro →",
        "ready_cta_inline": "Klar til at prøve eToro? — Toms affiliate-link.",
        "more_guides": "Flere guider",
        "guide_social": "Hvad er Social Trading?",
        "guide_copy": "Hvad er Copy Trading?",
        "guide_returns": "Hvor meget kan du tjene?",
        "guide_scam": "Er eToro svindel?",
        "guide_profits": "Udtage gevinster",
        "guide_pi": "Popular Investor-programmet",
        "guide_all_videos": "Alle videoer",
        "footer_brand": "Dokumenterer copy trading-rejsen siden 2017. Uafhængig, ærlig og altid lærende.",
        "footer_guides": "Guider",
        "footer_site": "Hjemmeside",
        "footer_updates": "Handelsopdateringer",
        "footer_about": "Om os",
        "footer_faq": "Ofte stillede spørgsmål",
        "footer_contact": "Kontakt",
        "home": "Hjem",
        "faq_heading": "Ofte stillede spørgsmål",
        "by_tom": "Af Tom",
        "breadcrumb_home": "Hjem",
        "breadcrumb_videos": "Videoer",
    },
    "el": {
        "social_trading": "Κοινωνικές Συναλλαγές",
        "copy_trading": "Copy Trading",
        "updates": "Ενημερώσεις",
        "videos": "Βίντεο",
        "about": "Σχετικά",
        "faq": "Συχνές ερωτήσεις",
        "try_etoro": "Δοκίμασε το eToro",
        "in_this_article": "Σε αυτό το άρθρο",
        "prefer_reading": "Προτιμάς να διαβάζεις; Η πλήρης μεταγραφή βρίσκεται παρακάτω.",
        "watch_on_youtube": "Δες στο YouTube με υπότιτλους",
        "risk_warning_label": "Προειδοποίηση κινδύνου",
        "risk_warning_banner": "Προειδοποίηση κινδύνου: Το 51% των λογαριασμών ιδιωτών επενδυτών χάνουν χρήματα κατά τη διαπραγμάτευση CFD με το eToro. Το κεφάλαιό σας κινδυνεύει.",
        "risk_warning_full": "Το eToro είναι μια πλατφόρμα επενδύσεων πολλαπλών περιουσιακών στοιχείων. Η αξία των επενδύσεών σας μπορεί να αυξηθεί ή να μειωθεί. Το 51% των λογαριασμών ιδιωτών επενδυτών χάνουν χρήματα κατά τη διαπραγμάτευση CFD με το eToro. Θα πρέπει να εξετάσετε εάν μπορείτε να αντέξετε τον υψηλό κίνδυνο απώλειας των χρημάτων σας.",
        "risk_warning_footer": "Το κεφάλαιό σας κινδυνεύει. Το 51% των λογαριασμών ιδιωτών επενδυτών χάνουν χρήματα κατά τη διαπραγμάτευση CFD με το eToro. Αυτός ο ιστότοπος είναι μόνο για εκπαιδευτικούς και ενημερωτικούς σκοπούς και δεν αποτελεί επενδυτική συμβουλή. Το Copy Trading δεν αποτελεί επενδυτική συμβουλή.",
        "risk_warning_sidebar": "Το 51% των λογαριασμών ιδιωτών επενδυτών χάνουν χρήματα κατά τη διαπραγμάτευση CFD με το eToro. Θα πρέπει να εξετάσετε εάν μπορείτε να αντέξετε τον υψηλό κίνδυνο απώλειας των χρημάτων σας. Αυτός είναι ένας σύνδεσμος συνεργάτη — ο Tom μπορεί να λάβει προμήθεια χωρίς κόστος για εσάς.",
        "important_reminder": "Σημαντική υπενθύμιση",
        "important_reminder_text": "Το 51% των λογαριασμών ιδιωτών επενδυτών χάνουν χρήματα κατά τη διαπραγμάτευση CFD με το eToro. Θα πρέπει να εξετάσετε εάν μπορείτε να αντέξετε τον υψηλό κίνδυνο απώλειας των χρημάτων σας. Τα προηγούμενα αποτελέσματα δεν αποτελούν ένδειξη μελλοντικών αποτελεσμάτων. Αυτό το περιεχόμενο είναι μόνο για εκπαιδευτικούς σκοπούς και δεν αποτελεί επενδυτική συμβουλή.",
        "ready_to_try": "Έτοιμος να δοκιμάσεις το eToro;",
        "toms_affiliate": "Ο Tom χρησιμοποιεί το eToro από το 2017. Εδώ είναι ο σύνδεσμος συνεργάτη του.",
        "explore_etoro": "Εξερεύνησε το eToro →",
        "ready_cta_inline": "Έτοιμος να δοκιμάσεις το eToro; — Σύνδεσμος συνεργάτη του Tom.",
        "more_guides": "Περισσότεροι οδηγοί",
        "guide_social": "Τι είναι το Social Trading;",
        "guide_copy": "Τι είναι το Copy Trading;",
        "guide_returns": "Πόσα μπορείς να κερδίσεις;",
        "guide_scam": "Είναι το eToro απάτη;",
        "guide_profits": "Ανάληψη κερδών",
        "guide_pi": "Πρόγραμμα Popular Investor",
        "guide_all_videos": "Όλα τα βίντεο",
        "footer_brand": "Καταγράφοντας το ταξίδι του copy trading από το 2017. Ανεξάρτητο, ειλικρινές και πάντα σε μάθηση.",
        "footer_guides": "Οδηγοί",
        "footer_site": "Ιστότοπος",
        "footer_updates": "Ενημερώσεις συναλλαγών",
        ...
        "breadcrumb_videos": "Βίντεο",
    },
    "cs": {
        "social_trading": "Sociální obchodování",
        "copy_trading": "Copy Trading",
        "updates": "Aktualizace",
        "videos": "Videa",
        "about": "O nás",
        "faq": "Časté dotazy",
        "try_etoro": "Vyzkoušej eToro",
        "in_this_article": "V tomto článku",
        "prefer_reading": "Raději čtete? Úplný přepis najdete níže.",
        "watch_on_youtube": "Sledujte na YouTube s titulky",
        "risk_warning_label": "Upozornění na riziko",
        "risk_warning_banner": "Upozornění na riziko: 51 % účtů retailových investorů přichází o peníze při obchodování CFD s eToro. Váš kapitál je ohrožen.",
        "risk_warning_full": "eToro je investiční platforma pro více tříd aktiv. Hodnota vašich investic může stoupat i klesat. 51 % účtů retailových investorů přichází o peníze při obchodování CFD s eToro. Měli byste zvážit, zda si můžete dovolit podstoupit vysoké riziko ztráty peněz.",
        "risk_warning_footer": "Váš kapitál je ohrožen. 51 % účtů retailových investorů přichází o peníze při obchodování CFD s eToro. Tyto webové stránky slouží pouze ke vzdělávacím a informačním účelům a nepředstavují investiční poradenství. Copy Trading nepředstavuje investiční poradenství.",
        "risk_warning_sidebar": "51 % účtů retailových investorů přichází o peníze při obchodování CFD s eToro. Měli byste zvážit, zda si můžete dovolit podstoupit vysoké riziko ztráty peněz. Toto je partnerský odkaz — Tom může obdržet provizi bez jakýchkoli nákladů pro vás.",
        "important_reminder": "Důležité upozornění",
        "important_reminder_text": "51 % účtů retailových investorů přichází o peníze při obchodování CFD s eToro. Měli byste zvážit, zda si můžete dovolit podstoupit vysoké riziko ztráty peněz. Minulé výsledky nejsou ukazatelem budoucích výsledků. Tento obsah slouží pouze ke vzdělávacím účelům a nepředstavuje investiční poradenství.",
        "ready_to_try": "Připraveni vyzkoušet eToro?",
        "toms_affiliate": "Tom používá eToro od roku 2017. Zde je jeho partnerský odkaz.",
        "explore_etoro": "Prozkoumejte eToro →",
        "ready_cta_inline": "Připraveni vyzkoušet eToro? — Partnerský odkaz Toma.",
        "more_guides": "Další průvodce",
        "guide_social": "Co je sociální obchodování?",
        "guide_copy": "Co je Copy Trading?",
        "guide_returns": "Kolik můžete vydělat?",
        "guide_scam": "Je eToro podvod?",
        "guide_profits": "Vybírání zisků",
        "guide_pi": "Program Popular Investor",
        "guide_all_videos": "Všechna videa",
        "footer_brand": "Dokumentujeme cestu copy tradingem od roku 2017. Nezávisle, upřímně a stále se učíme.",
        "footer_guides": "Průvodce",
        "footer_site": "Web",
        "footer_updates": "Obchodní aktualizace",
        "footer_about": "O nás",
        "footer_faq": "Časté dotazy",
        "footer_contact": "Kontakt",
        "home": "Domů",
        "faq_heading": "Časté dotazy",
        "by_tom": "Od Toma",
        "breadcrumb_home": "Domů",
        "breadcrumb_videos": "Videa",
    },
    "it": {
        "social_trading": "Social Trading",
        "copy_trading": "Copy Trading",
        ...
        "try_etoro": "Prova eToro",
        "in_this_article": "In questo articolo",
        "prefer_reading": "Preferisci leggere? La trascrizione completa è qui sotto.",
        "watch_on_youtube": "Guarda su YouTube con sottotitoli",
        "risk_warning_label": "Avvertenza sui rischi",
        "risk_warning_banner": "Avvertenza sui rischi: il 51% dei conti degli investitori al dettaglio perde denaro quando negozia CFD con eToro. Il tuo capitale è a rischio.",
        "risk_warning_full": "eToro è una piattaforma di investimento multi-asset. Il valore dei tuoi investimenti può salire o scendere. Il 51% dei conti degli investitori al dettaglio perde denaro quando negozia CFD con eToro. Dovresti valutare se puoi permetterti l'alto rischio di perdere i tuoi soldi.",
        "risk_warning_footer": "Il tuo capitale è a rischio. Il 51% dei conti degli investitori al dettaglio perde denaro quando negozia CFD con eToro. Questo sito web è solo a scopo educativo e informativo e non costituisce consulenza sugli investimenti. Il Copy Trading non costituisce consulenza sugli investimenti.",
        "risk_warning_sidebar": "Il 51% dei conti degli investitori al dettaglio perde denaro quando negozia CFD con eToro. Dovresti valutare se puoi permetterti l'alto rischio di perdere i tuoi soldi. Questo è un link di affiliazione — Tom potrebbe ricevere una commissione senza costi aggiuntivi per te.",
        "important_reminder": "Promemoria importante",
        "important_reminder_text": "Il 51% dei conti degli investitori al dettaglio perde denaro quando negozia CFD con eToro. Dovresti valutare se puoi permetterti l'alto rischio di perdere i tuoi soldi. I risultati passati non sono indicativi di risultati futuri. Questo contenuto è solo a scopo educativo e non costituisce consulenza sugli investimenti.",
        "ready_to_try": "Pronto a provare eToro?",
        "toms_affiliate": "Tom usa eToro dal 2017. Ecco il suo link di affiliazione.",
        "explore_etoro": "Scopri eToro →",
        "ready_cta_inline": "Pronto a provare eToro? — Link di affiliazione di Tom.",
        "more_guides": "Altre guide",
        "guide_social": "Cos'è il Social Trading?",
        "guide_copy": "Cos'è il Copy Trading?",
        "guide_returns": "Quanto puoi guadagnare?",
        "guide_scam": "eToro è una truffa?",
        "guide_profits": "Prelevare i profitti",
        "guide_pi": "Programma Popular Investor",
        "guide_all_videos": "Tutti i video",
        "footer_brand": "Documentiamo il viaggio nel copy trading dal 2017. Indipendenti, onesti e sempre in apprendimento.",
        "footer_guides": "Guide",
        "footer_site": "Sito",
        "footer_updates": "Aggiornamenti di trading",
    ...
    "nl": {
        ...
        "try_etoro": "Probeer eToro",
        "in_this_article": "In dit artikel",
        "prefer_reading": "Liever lezen? Het volledige transcript staat hieronder.",
        "watch_on_youtube": "Bekijk op YouTube met ondertiteling",
        "risk_warning_label": "Risicowaarschuwing",
        "risk_warning_banner": "Risicowaarschuwing: 51% van de particuliere beleggersrekeningen verliest geld bij het handelen in CFD's met eToro. Uw kapitaal loopt risico.",
        "risk_warning_full": "eToro is een beleggingsplatform voor meerdere activa. De waarde van uw beleggingen kan stijgen of dalen. 51% van de particuliere beleggersrekeningen verliest geld bij het handelen in CFD's met eToro. U dient te overwegen of u het zich kunt veroorloven om het hoge risico te nemen uw geld te verliezen.",
        "risk_warning_footer": "Uw kapitaal loopt risico. 51% van de particuliere beleggersrekeningen verliest geld bij het handelen in CFD's met eToro. Deze website is uitsluitend bedoeld voor educatieve en informatieve doeleinden en vormt geen beleggingsadvies. Copy Trading vormt geen beleggingsadvies.",
        "risk_warning_sidebar": "51% van de particuliere beleggersrekeningen verliest geld bij het handelen in CFD's met eToro. U dient te overwegen of u het zich kunt veroorloven om het hoge risico te nemen uw geld te verliezen. Dit is een affiliate-link — Tom kan een commissie ontvangen zonder extra kosten voor u.",
        "important_reminder": "Belangrijke herinnering",
        "important_reminder_text": "51% van de particuliere beleggersrekeningen verliest geld bij het handelen in CFD's met eToro. U dient te overwegen of u het zich kunt veroorloven om het hoge risico te nemen uw geld te verliezen. In het verleden behaalde resultaten bieden geen garantie voor de toekomst. Deze inhoud is uitsluitend voor educatieve doeleinden en vormt geen beleggingsadvies.",
        "ready_to_try": "Klaar om eToro te proberen?",
        "toms_affiliate": "Tom gebruikt eToro sinds 2017. Hier is zijn affiliate-link.",
        "explore_etoro": "Ontdek eToro →",
        "ready_cta_inline": "Klaar om eToro te proberen? — Toms affiliate-link.",
        "more_guides": "Meer gidsen",
        "guide_social": "Wat is Social Trading?",
        "guide_copy": "Wat is Copy Trading?",
        "guide_returns": "Hoeveel kun je verdienen?",
        "guide_scam": "Is eToro oplichterij?",
        "guide_profits": "Winst opnemen",
        "guide_pi": "Popular Investor-programma",
        "guide_all_videos": "Alle video's",
        "footer_brand": "Het copy trading-avontuur documenteren sinds 2017. Onafhankelijk, eerlijk en altijd lerend.",
        "footer_guides": "Gidsen",
        "footer_site": "Website",
        "footer_updates": "Handelsupdates",
    ...
    "pl": {
        ...
        "about": "O nas",
        "faq": "FAQ",
        "try_etoro": "Wypróbuj eToro",
        "in_this_article": "W tym artykule",
        "prefer_reading": "Wolisz czytać? Pełna transkrypcja jest poniżej.",
        "watch_on_youtube": "Oglądaj na YouTube z napisami",
        "risk_warning_label": "Ostrzeżenie o ryzyku",
        "risk_warning_banner": "Ostrzeżenie o ryzyku: 51% rachunków inwestorów detalicznych traci pieniądze podczas handlu kontraktami CFD z eToro. Twój kapitał jest zagrożony.",
        "risk_warning_full": "eToro to wieloaktywowa platforma inwestycyjna. Wartość Twoich inwestycji może wzrosnąć lub spaść. 51% rachunków inwestorów detalicznych traci pieniądze podczas handlu kontraktami CFD z eToro. Powinieneś rozważyć, czy możesz sobie pozwolić na wysokie ryzyko utraty pieniędzy.",
        "risk_warning_footer": "Twój kapitał jest zagrożony. 51% rachunków inwestorów detalicznych traci pieniądze podczas handlu kontraktami CFD z eToro. Ta strona służy wyłącznie celom edukacyjnym i informacyjnym i nie stanowi porady inwestycyjnej. Copy Trading nie stanowi porady inwestycyjnej.",
        "risk_warning_sidebar": "51% rachunków inwestorów detalicznych traci pieniądze podczas handlu kontraktami CFD z eToro. Powinieneś rozważyć, czy możesz sobie pozwolić na wysokie ryzyko utraty pieniędzy. To jest link partnerski — Tom może otrzymać prowizję bez dodatkowych kosztów dla Ciebie.",
        "important_reminder": "Ważne przypomnienie",
        "important_reminder_text": "51% rachunków inwestorów detalicznych traci pieniądze podczas handlu kontraktami CFD z eToro. Powinieneś rozważyć, czy możesz sobie pozwolić na wysokie ryzyko utraty pieniędzy. Wyniki z przeszłości nie stanowią wskazania przyszłych wyników. Treść ta służy wyłącznie celom edukacyjnym i nie stanowi porady inwestycyjnej.",
        "ready_to_try": "Gotowy, żeby wypróbować eToro?",
        "toms_affiliate": "Tom korzysta z eToro od 2017 roku. Oto jego link partnerski.",
        "explore_etoro": "Poznaj eToro →",
        "ready_cta_inline": "Gotowy, żeby wypróbować eToro? — Link partnerski Toma.",
        "more_guides": "Więcej poradników",
        "guide_social": "Czym jest Social Trading?",
        "guide_copy": "Czym jest Copy Trading?",
        "guide_returns": "Ile możesz zarobić?",
        "guide_scam": "Czy eToro to oszustwo?",
        "guide_profits": "Wypłacanie zysków",
        "guide_pi": "Program Popular Investor",
        "guide_all_videos": "Wszystkie filmy",
        "footer_brand": "Dokumentujemy przygodę z copy tradingiem od 2017 roku. Niezależnie, uczciwie i ciągle się ucząc.",
        "footer_guides": "Poradniki",
        "footer_site": "Strona",
        "footer_updates": "Aktualizacje handlowe",
        "footer_about": "O nas",
        "footer_faq": "FAQ",
        "footer_contact": "Kontakt",
        "home": "Strona główna",
